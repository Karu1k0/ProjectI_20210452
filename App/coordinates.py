...
edge_list = [('point_14', 'point_12'), ('point_12', 'point_14'),
             ...
             ('new_point_1', 'new_point_2'), ('new_point_2', 'new_point_1'), ('new_point_2', 'new_point_3'),
             ('new_point_3', 'new_point_2'),
             ('new_point_3', 'new_point_4'), ('new_point_4', 'new_point_3'), ('new_point_4', 'new_point_5'),
             ('new_point_5', 'new_point_4'),
             ('new_point_5', 'new_point_6'), ('new_point_6', 'new_point_5'), ('new_point_6', 'new_point_7'),
             ('new_point_7', 'new_point_6'),
